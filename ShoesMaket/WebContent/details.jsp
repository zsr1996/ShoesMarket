...
<%@page import="com.oracle.shoesMaket.model.dao.ShoesDAOImp"%>
...
<div class="header_btm">
		...
		<nav id="menu-left">
			<ul>
				...
				<li><a href="products.jsp">åå</a></li>
	...
	<div class="single">
				...
				<div class="product-view">
				    ...
				    <div class="product-image"> 
				        <a class="cs-fancybox-thumbs cloud-zoom" rel="adjustX:30,adjustY:0,position:'right',tint:'#202020',tintOpacity:0.5,smoothMove:2,showTitle:true,titleOpacity:0.5" data-fancybox-group="thumb" href="images/0001-2.jpg" title="Women Shorts" alt="Women Shorts">
				           	<img src="${requestScope.shoe.xiezitupian}" alt="Women Shorts" title="Women Shorts" />
				        </a>
				   </div>
					<script type="text/javascript">
			...
			<div class="span1_of_1_des">				  
				  <div class="desc1">
					...
					<h3>${requestScope.shoe.pinpaiming}</h3>
					<h5>${requestScope.shoe.shoujia} <a href="#">click for offer</a></h5>
					<div class="available">
						<div class="btn_form">
							<form>
...
<div class="footer">
	...
	<div class="copy">
		<p class="link"><span>Copyright &copy; 2016.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="Ã¦Â¨Â¡Ã¦ÂÂ¿Ã¤Â¹ÂÃ¥Â®Â¶">Ã¦Â¨Â¡Ã¦ÂÂ¿Ã¤Â¹ÂÃ¥Â®Â¶</a> - Collect from <a href="http://www.cssmoban.com/" title="Ã§Â½ÂÃ©Â¡ÂµÃ¦Â¨Â¡Ã¦ÂÂ¿" target="_blank">Ã§Â½ÂÃ©Â¡ÂµÃ¦Â¨Â¡Ã¦ÂÂ¿</a></p>
	</div>
	<div class="clear"></div>
</div>
</div>
