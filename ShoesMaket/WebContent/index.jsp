...
<c:if test="${requestScope.allShoes eq null }">
	<c:redirect url="ShoesServlet?method=index"></c:redirect>
</c:if>
	 ...
	 -->	
		 ...
		 <div class="log_reg">
				...
				<c:if test="${loginedUser ne null}">
					<li><a href="UserServlet?method=loadProfile&userid=${loginedUser.userid}">${loginedUser.email}</a> </li>					
				</c:if>	
...
<div class="main">
	...
	<c:forEach var='s' items="${requestScope.allShoes}">
	...
	<div class="grid1_of_3">
		...
		<a href="ShoppingCarServlet?method=add&shoeid=${s.shoeid}">		
			<img src="images/shoppingCar.png" width="25" height="25" title="添加到购物车" style="margin: 0px;padding: 0px;position: relative;top: 1px;border-radius:12.5px" />						
		</a>
	</div>
	</c:forEach>
	</div>
	...
	<div>
	<a href="ShoesServlet?method=listShoesByPage&page=1&count=3" style="position:relative;left:-535px">查看更多 >></a>	
	</div>
